...
> **Last updated**: April 7, 2026 — Post source-code restoration (ADR-007 + list_orphans)
...
| Metric                                | Value                              | As Of  |
| ------------------------------------- | ---------------------------------- | ------ |
| Source modules (`src/claude_memory/`) | 32                                 | Apr 7  |
| Scripts (`scripts/`)                  | 59                                 | Apr 7  |
| Unit tests                            | 1,121                              | Apr 7  |
| Test files                            | 77                                 | Apr 7  |
...
| [007-hybrid-search-unification.md](file:///C:/Users/Asus/.gemini/antigravity/scratch/new_project/claude-memory-mcp/docs/adr/007-hybrid-search-unification.md) | Hybrid search unification        | Accepted |
