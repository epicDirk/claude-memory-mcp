...
class TestClassify:
    ...
    def test_sad1_empty_query_returns_semantic(self, router: QueryRouter) -> None:
        """Empty query defaults to SEMANTIC."""
        assert router.classify("") == QueryIntent.SEMANTIC

    def test_happy_plain_query_returns_semantic(self, router: QueryRouter) -> None:
    ...
    def test_happy_temporal_queries(self, router: QueryRouter, query: str) -> None:
    ...
    def test_happy_relational_queries(self, router: QueryRouter, query: str) -> None:
    ...
    def test_happy_associative_queries(self, router: QueryRouter, query: str) -> None:
        """Associative keywords trigger ASSOCIATIVE intent."""
        assert router.classify(query) == QueryIntent.ASSOCIATIVE

    def test_happy_temporal_takes_priority_over_relational(self, router: QueryRouter) -> None:
    ...
    def test_happy_relational_takes_priority_over_associative(self, router: QueryRouter) -> None:
...
class TestRoute:
    ...
    @pytest.mark.asyncio()
    async def test_happy_route_semantic(self, router: QueryRouter, mock_service: MagicMock) -> None:
    ...
    @pytest.mark.asyncio()
    async def test_happy_route_temporal(self, router: QueryRouter, mock_service: MagicMock) -> None:
    ...
    @pytest.mark.asyncio()
    async def test_happy_route_relational_with_quoted_entities(
    ...
    @pytest.mark.asyncio()
    async def test_sad3_route_relational_fallback_to_search(
        self, router: QueryRouter, mock_service: MagicMock
    ) -> None:
    ...
    @pytest.mark.asyncio()
    async def test_happy_explicit_intent_override(
        self, router: QueryRouter, mock_service: MagicMock
    ) -> None:
    ...
    @pytest.mark.asyncio()
    async def test_happy_route_passes_limit_and_project(
        self, router: QueryRouter, mock_service: MagicMock
    ) -> None:
...
class TestQueryIntent:
    ...
    def test_happy_values(self) -> None:
    ...
    def test_happy_from_string(self) -> None:
...
class TestSearchStrategy:
    ...
    @pytest.mark.asyncio()
    async def test_sad4_search_strategy_auto_logs_deprecation(self) -> None:
