...
class TestToolsExtraDefaults:
    ...
    def test_happy_search_assoc_evil_limit(self) -> None:
    ...
    def test_happy_search_assoc_evil_decay(self) -> None:
    ...
    def test_happy_search_assoc_evil_max_hops(self) -> None:
    ...
    def test_happy_query_timeline_sad_limit(self) -> None:
    ...
    def test_sad36_tools_extra_happy_all_defaults(self) -> None:
...
class TestPageRankDefaults:
    ...
    def test_sad37_defaults_evil_damping(self) -> None:
    ...
    def test_sad38_defaults_evil_iterations(self) -> None:
    ...
    def test_sad40_defaults_sad_reasonable_range(self) -> None:
...
class TestActivationDefaults:
    ...
    def test_sad42_defaults_evil_spread_decay(self) -> None:
    ...
    def test_sad43_defaults_evil_spread_max_hops(self) -> None:
    ...
    def test_sad44_defaults_evil_not_mutated(self) -> None:
    ...
    def test_sad45_defaults_sad_decay_in_range(self) -> None:
