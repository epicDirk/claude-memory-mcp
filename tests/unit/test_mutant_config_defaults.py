...
class TestRepositoryDefaults:
    ...
    def test_happy_repo_evil_host_not_mutated(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_happy_repo_evil_port_not_mutated(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_happy_repo_evil_graph_name_not_mutated(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_happy_repo_sad_env_override_host(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_sad1_repo_happy_all_defaults(self, monkeypatch: pytest.MonkeyPatch) -> None:
...
class TestRepositoryConstants:
    ...
    def test_happy_max_retries_evil(self) -> None:
    ...
    def test_happy_base_delay_evil(self) -> None:
    ...
    def test_happy_constants_evil_types(self) -> None:
    ...
    def test_happy_constants_sad_positive(self) -> None:
    ...
    def test_happy_constants_happy(self) -> None:
...
class TestLockManagerDefaults:
    ...
    def test_happy_lock_evil_host_not_mutated(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_happy_lock_evil_port_not_mutated(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_happy_lock_evil_redis_host_env_chain(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_sad2_lock_sad_falkordb_fallback(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_sad3_lock_happy_all_defaults(self, monkeypatch: pytest.MonkeyPatch) -> None:
...
class TestRetryDefaults:
    ...
    def test_happy_transient_evil_builtins_present(self) -> None:
    ...
    def test_sad4_transient_evil_not_empty(self) -> None:
        """Evil: tuple must have at least the 3 builtins."""
        assert len(_TRANSIENT_EXCEPTIONS) >= 3

    def test_happy_transient_evil_no_base_exception(self) -> None:
    ...
    def test_happy_transient_sad_type_is_tuple(self) -> None:
        """Sad: must be a tuple, not a list."""
        assert isinstance(_TRANSIENT_EXCEPTIONS, tuple)

    def test_happy_transient_happy(self) -> None:
...
class TestRetryBackoffMath:
    ...
    def test_happy_backoff_sad_custom_values(self) -> None:
    ...
    def test_happy_backoff_happy_full_sequence(self) -> None:
...
class TestRetryDecorator:
    ...
    def test_evil1_decorator_evil_default_max_retries(self) -> None:
    ...
    def test_evil2_decorator_evil_custom_max_retries(self) -> None:
    ...
    def test_evil3_decorator_evil_only_catches_transient(self) -> None:
    ...
    def test_happy_decorator_sad_succeeds_on_retry(self) -> None:
    ...
    def test_happy_decorator_happy_no_failure(self) -> None:
...
class TestVectorStoreDefaults:
    ...
    def test_sad7_vector_store_happy_defaults(self) -> None:
